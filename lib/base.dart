...
abstract class Base<T extends StatefulWidget> extends State<T> {
  ...
  saveCurrency(String currencySymbol, int currencyId) {
    print("CURRENCY FUNCTION TRIGGERED");
    if (preferences != null) {
      preferences.setString("currencySymbol", currencySymbol);
      preferences.setInt("currencyId", currencyId);
    }
  }

  saveJournal(String journalName, int journalId) {
    print("JOURNAL FUNCTION TRIGGERED");
    if (preferences != null) {
      preferences.setString("journalName", journalName);
      preferences.setInt("journalId", journalId);
    }
  }

  saveStockLocation(String stockLocationName, int stockLocationId) {
    print("STOCK LOCATION FUNCTION TRIGGERED");
    if (preferences != null) {
      preferences.setString("stockLocationName", stockLocationName);
      preferences.setInt("stockLocationId", stockLocationId);
    }
  }
