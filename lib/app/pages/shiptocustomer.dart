...
import 'package:spouts_inventory_odoo/app/pages/deliverydetails.dart';
...
class ShipToCustomer extends StatefulWidget {
  @override
  _ShipToCustomerState createState() => _ShipToCustomerState();
}

class _ShipToCustomerState extends Base<ShipToCustomer> {
  //Odoo _odoo;
  String fullname;
  String _result;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
        title: Text("Ship Stock to Customer"),
        actions: <Widget>[
          // IconButton(
          //   onPressed: () async {
      ...
      body: _stockPickings.length > 0
          ? Container(
              ...
              child: ListView.builder(
                itemCount: _stockPickings.length,
                physics: const AlwaysScrollableScrollPhysics(),
                itemBuilder: (context, i) => GestureDetector(
                  onTap: () {
                    push(DeliveryDetails(data: _stockPickings[i]));
                  },
                  child: Card(
                    child: Column(
                      children: <Widget>[
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          width: MediaQuery.of(context)
                                              ...
                                              0.5,
                                          child: Text(
                                            (_stockPickings[i].scheduled_date),
                                            overflow: TextOverflow.visible,
                                            style: TextStyle(
                                                color: Colors.grey[700],
