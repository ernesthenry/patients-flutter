...
class ShipToSales extends StatefulWidget {
  @override
  _ShipToSalesState createState() => _ShipToSalesState();
}

class _ShipToSalesState extends Base<ShipToSales> {
  //Odoo _odoo;
  String fullname;
  String _result;
        ...
        for (var i in invoicelist) {
          _requisitions.add(
            new Requisition(
              ...
              requested_by: i["requested_by"] is! bool ? i["requested_by"] : [],
              employee_id: i['employee_id'] is! bool ? i['employee_id'] : [],
              request_date: i['request_date'] is! bool ? i['request_date'] : "",
